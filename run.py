...
# general setting
parser.add_argument('-b', '--benchmark', choices=['DQN', 'NatureDQN', 'DoubleDQN', 'DuelingDQN'], default='DQN', help="Names of benchmarks you select.")
...
parser.add_argument('--lr', default=2e-3, type=float, help='Learning rate for neural networks\' upate.')
